                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center"> <img
                                            ...
                                            style="height: 90px;widht: 90px" alt=""> </h3>
                                    <h3 class="text-center font-weight-light my-4"> Login </h3>
                                </div>
                                <div class="card-body">
                                    @if (session('Gagal'))
                                        <p class="text-center text-danger">{{ session('Gagal') }}</p>
                                    @endif
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="{{ route ('registrasi.tampil') }}">Need an account? Sign up!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
